...
namespace LXMS
{
    public partial class ASSET_ADD : Form
    {
        ...
        private void ASSET_ADD_Load(object sender, EventArgs e)
        {
        ...
        private void ASSET_ADD_Shown(object sender, EventArgs e)
        {
        }
        ...
        private void LoadData()
        {
            try
            {
                ...
                BindingCollection<modAssetAdd> list = _dal.GetIList(rbStatus0.Checked ? "0" : "1", string.Empty, string.Empty, rbStatus0.Checked ? string.Empty : dtpFrom.Text, rbStatus0.Checked ? string.Empty : dtpTo.Text, out Util.emsg);
