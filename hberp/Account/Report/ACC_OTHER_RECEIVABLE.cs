...
namespace LXMS
{
    public partial class ACC_OTHER_RECEIVABLE : Form
    {
        dalAccOtherReceivable _dal = new dalAccOtherReceivable();
        public ACC_OTHER_RECEIVABLE()
        {
            InitializeComponent();
        }
        ...
        private void ACC_OTHER_RECEIVABLE_Shown(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void LoadData()
        {
            try
            {
                ...
                BindingCollection<modOtherReceivableSummary> list = _dal.GetOtherReceivableSummary(cboAccName.ComboBox.SelectedValue.ToString(), out Util.emsg);
        ...
        private void mnuDetail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BindingCollection<modAccOtherReceivable> list = _dal.GetIList(cboAccName.ComboBox.SelectedValue.ToString(), DBGrid.CurrentRow.Cells["objectname"].Value.ToString(), out Util.emsg);
