...
namespace LXMS
{
    public partial class OTHER_PAYABLE_OBJECT : BaseFormEdit
    {
        dalOtherPayableObject _dal = new dalOtherPayableObject();
        public OTHER_PAYABLE_OBJECT()
        {
            InitializeComponent();
            SelectVisible = false;
        }

        private void OTHER_PAYABLE_OBJECT_Load(object sender, EventArgs e)
        {
        ...
        {
            BindingCollection<modOtherPayableObject> list = _dal.GetIList(false, out Util.emsg);
        ...
        protected override void Find()
        {
            ...
            {
                modOtherPayableObject mod = (modOtherPayableObject)DBGrid.Rows[i].DataBoundItem;
        ...
        private void DBGrid_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                modOtherPayableObject mod = (modOtherPayableObject)DBGrid.CurrentRow.DataBoundItem;
        ...
        private void OTHER_PAYABLE_OBJECT_DoubleClick(object sender, EventArgs e)
        {
            if (SelectVisible)
                Select();
        }
