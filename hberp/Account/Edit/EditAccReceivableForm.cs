...
namespace LXMS
{
    public partial class EditAccReceivableForm : Form
    {
        ...
        private void EditAccReceivableForm_Load(object sender, EventArgs e)
        {
            clsTranslate.InitLanguage(this);            
            txtId.ReadOnly = true;
            if (clsLxms.GetParameterValue("NEED_RECEIVABLE_NO").CompareTo("T") == 0)
        ...
        public void EditItem(int id)
        {
            try
            {
                ...
                _action = "EDIT";
                modAccReceivableForm mod = _dal.GetItem(id, out Util.emsg);
                if (mod != null)
                {
        ...
        private void toolSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                modAccReceivableForm mod = new modAccReceivableForm();
        ...
        private void btnCust_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtCustId.Text = Util.retValue1;
                    txtCustName.Text = Util.retValue2;
                }
            }
            catch (Exception ex)
            {
