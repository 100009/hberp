...
namespace LXMS
{
    public partial class ACC_PAYABLE_FORM : Form
    {
        dalAccPayableForm _dal = new dalAccPayableForm();
        public ACC_PAYABLE_FORM()
        {
            InitializeComponent();
        }

        private void ACC_PAYABLE_FORM_Load(object sender, EventArgs e)
        {
        ...
        private void ACC_PAYABLE_FORM_Shown(object sender, EventArgs e)
        {
        ...
        private void LoadData()
        {
            try
            {
                ...
                BindingCollection<modAccPayableForm> list = _dal.GetIList(rbStatus0.Checked ? "0" : "1", string.Empty, string.Empty, rbStatus0.Checked ? string.Empty : dtpFrom.Text, rbStatus0.Checked ? string.Empty : dtpTo.Text, out Util.emsg);
