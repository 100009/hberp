...
namespace LXMS.DAL
{
    public class dalOtherReceivableObject
    {
        /// <summary>
        ...
        public BindingCollection<modOtherReceivableObject> GetIList(bool validonly, out string emsg)
        {
            try
            {
                ...
                string sql = "select object_name,status,currency,link_man,addr,tel,remark,update_user,update_time from other_receivable_object where 1=1 " + getwhere + " order by object_name";
        ...
        /// <param name=objectname>objectname</param>
        /// <param name=out emsg>return error message</param>
        ///<returns>get a record detail of otherreceivableobject</returns>
        public modOtherReceivableObject GetItem(string objectname,out string emsg)
        {
            try
            {
        ...
        /// <summary>
        /// <param name=out emsg>return error message</param>
        ///<returns>get record count of otherreceivableobject</returns>
        public int TotalRecords(out string emsg)
        {
            try
            {
                string sql = "select count(1) from other_receivable_object";
                emsg = null;
        ...
        public bool Update(string objectname,modOtherReceivableObject mod,out string emsg)
        {
            try
            {
                string sql = string.Format("update other_receivable_object set status={0},link_man='{1}',addr='{2}',tel='{3}',remark='{4}',update_user='{5}',update_time=getdate() where object_name='{6}'",mod.Status,mod.LinkMan,mod.Addr,mod.Tel,mod.Remark,mod.UpdateUser,objectname);
                int i = SqlHelper.ExecuteNonQuery(sql);
                if (i > 0)
                {
                    emsg = null;
        ...
        /// <summary>
        /// delete a otherreceivableobject
        /// <summary>
        /// <param name=objectname>objectname</param>
        /// <param name=out emsg>return error message</param>
        /// <returns>true/false</returns>
        public bool Delete(string objectname,out string emsg)
        {
            try
            {
                string sql = string.Format("delete other_receivable_object where object_name='{0}' ",objectname);
                int i = SqlHelper.ExecuteNonQuery(sql);
                if (i > 0)
                {
                    emsg = null;
        ...
        /// <summary>
        /// change otherreceivableobject's status(valid/invalid)
        /// <summary>
        /// <param name=objectname>objectname</param>
        /// <param name=out emsg>return error message</param>
        /// <returns>true/false</returns>
        public bool Inactive(string objectname,out string emsg)
        {
            try
            {
                string sql = string.Format("update other_receivable_object set status=1-status where object_name='{0}' ",objectname);
                int i = SqlHelper.ExecuteNonQuery(sql);
                if (i > 0)
                {
                    emsg = null;
        ...
        public bool Exists(string objectname, out string emsg)
        {
            try
            {
                string sql = string.Format("select count(1) from other_receivable_object where object_name='{0}' ",objectname);
