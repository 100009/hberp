...
namespace MRPC.DBUtility
{
    public abstract class OracleDbHelper
    {
        ...
        public static readonly string connectionBackup = ConfigurationManager.ConnectionStrings["BackupConnString"].ConnectionString;
        ...
        public static OracleConnection getConn()
        {
            if (connflag == 0)
                ...
                return new OracleConnection(connectionBackup);
        }
        /// <summary>
